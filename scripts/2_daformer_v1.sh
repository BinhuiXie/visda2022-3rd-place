...
CUDA_VISIBLE_DEVICES=2 python -m tools.test configs/daformer/zerowaste_to_zerowastev2_daformer_mit5.py experiment/baseline/daformerV1/latest.pth --format-only --show-dir experiment/baseline/daformerV1/predictions --opacity 1
