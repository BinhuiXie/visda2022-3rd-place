...
CUDA_VISIBLE_DEVICES=5 python -m tools.train configs/source_only/synaugzerov1_to_zerov2_segformer.json --work-dir experiment/baseline/5_class/synaugzerov1_to_zerov2_segformer/
CUDA_VISIBLE_DEVICES=5 python -m tools.test configs/source_only/synaugzerov1_to_zerov2_segformer.json experiment/baseline/5_class/synaugzerov1_to_zerov2_segformer/latest.pth --format-only --show-dir experiment/baseline/5_class/synaugzerov1_to_zerov2_segformer/predictions --opacity 1
