...
CUDA_VISIBLE_DEVICES=6 python -m tools.train configs/source_only/synaugzerov1_to_zerov2_segformer_convert-clean.json --work-dir experiment/baseline/5_class_convert-clean/synaugzerov1_to_zerov2_segformer/
...
CUDA_VISIBLE_DEVICES=6 python -m tools.convert_visuals_to_labels experiment/baseline/5_class_convert-clean/synaugzerov1_to_zerov2_segformer/predictions experiment/baseline/5_class_convert-clean/synaugzerov1_to_zerov2_segformer/original/
