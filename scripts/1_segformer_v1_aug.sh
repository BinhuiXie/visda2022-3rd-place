...
CUDA_VISIBLE_DEVICES=1 python -m tools.test configs/source_only/synthzerowaste_segformer.json experiment/baseline/segformerV1Aug/latest.pth --format-only--show-dir experiment/baseline/segformerV1Aug/predictions --opacity 1
